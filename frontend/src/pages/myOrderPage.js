function myOrderPageRender() {
    var content = $('#content');
    content.html('<div id="myorder" ></div>');
    myOrderListRender();
}

function myOrderListRender() {
    ...
    orderThead.innerHTML = '<tr><th scope="col">#</th><th scope="col">Пользователь</th><th scope="col">Заказ</th><th scope="col">Статус</th><th scope="col">Удалить</th>';
    ...
    orders.forEach(function (items, index) {
        ...
        userInfo.onclick = function () {
            ...
            //$('.orderCartBody').append("<b>Адрес:</b> " + userOrder.otherOptions[0] + " | " + userOrder.otherOptions[1], '<br />');
